...
export const description = (title, id, name) => {
  return `Quý vị đang xem nội dung tin rao "[${title}], LH: [${name}]" - Mã tin [${id}]. Mọi thông tin, nội dung liên quan tới tin rao này là do người đăng tin đăng tải và chịu trách nhiệm. BDS.com.vn luôn cố gắng để các thông tin được hữu ích nhất cho quý vị tuy nhiên BDS.com.vn không đảm bảo và không chịu trách nhiệm về bất kỳ thông tin, nội dung nào liên quan tới tin rao này. Trường hợp phát hiện nội dung tin đăng không chính xác, Quý vị hãy thông báo và cung cấp thông tin cho Ban quản trị bds.com.vn theo Hotline 0383994171 để được hỗ trợ nhanh và kịp thời nhất.
`;
};