...
const Services = () => {
  return (
    ...
    //             </p>
    //           </CardContent>
    //           <CardFooter className='bg-red-400'>
    ...
    <section className="py-16 ">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold mb-8 text-center text-[#001C43]">
          Dịch vụ của chúng tôi
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {["Mua", "Bán", "Cho Thuê"].map((service) => (
            <Card key={service} className="text-center flex flex-col ">
              <CardHeader className='py-4'>
                <CardTitle className="text-main font-roboto py-2 text-3xl">{service}</CardTitle>
              </CardHeader>
              <CardContent className="flex-1 min-h-[200px] text-2xl">
                <p>
                  {service === "Mua"
                    ? "Khám phá các sản phẩm chất lượng cao với giá cả hợp lý. Chúng tôi cam kết cung cấp dịch vụ tốt nhất để bạn tìm thấy sản phẩm hoàn hảo cho nhu cầu của mình."
                    : service === "Bán"
              ...
              <CardFooter className="h-[60px] flex items-center justify-center ">
