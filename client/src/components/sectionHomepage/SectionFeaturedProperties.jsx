  ...
  return (
    <section className="py-14 z-10 ">
      <div className="container mx-auto ">
        ...
        <span className="space-x-2 text-sm text-main">
          <Link className="hover:cursor-pointer hover:text-primary" to={pathnames.public.rentProperty}>Nhà đất cho thuê</Link>
            <span>|</span>
          <Link className="hover:cursor-pointer hover:text-primary" to={pathnames.public.soldProperty}>Nhà đất bán</Link>
        </span>
        </div>
                ...
                <Card key={el.id} className="w-full h-full px-1 flex flex-col">
                  <div className="relative overflow-hidden aspect-[3/2]">
                    <img
                      src={el.images[0]}
                      alt="Property"
                      className="w-full h-full object-cover rounded hover:animate-scale-up-center"
                    />
                  ...
                  <div className="py-1 px-2 space-y-1">
                    <Link
                      className="font-roboto text-sm truncate block hover:underline"
                      to={`${pathnames.public.Property_Detail}/${el.idPost}`}
                    >
                      {el.title.length > 25
                        ? el.title.slice(0, 25) + "..."
                        : el.title}
