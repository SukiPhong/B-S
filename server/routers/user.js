...
router.post("/chartUser",verify.verifyTokenAdmin,UserController.chartUserRegistrations)
router.post("/NewUser", verify.verifyTokenAdmin, UserController.NewUserByAdmin);
router.patch('/upUserByAdmin',verify.verifyTokenAdmin,UserController.updateUserByAdmin)
